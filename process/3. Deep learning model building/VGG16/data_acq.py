...
pathA = r'D:\A'#The address of the data folder A (the initial total address)
pathB = r'D:\B'#The address of the data folder B (the initial total address)
...
def load(path):
    for file in os.listdir(path):
        ...
        if os.path.isdir(file_path):  
            ...
            if os.path.splitext(file)[0] == '2D data':#The file name and the extension were separated, and it was determined whether it was a file in nii format
...
#Add it when extracting features
